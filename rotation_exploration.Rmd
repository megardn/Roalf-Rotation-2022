...
NOTE: Code relies on files saved in directory `/data` not tracked in git
...
df_sum[nrow(df_sum) + 1,] = c("CAPA", length(which(redcap$timepoint==2)), "subjects with 2+ diagnoses in REDCap (CAPA)")
```
...
change in other GAF scores over time
